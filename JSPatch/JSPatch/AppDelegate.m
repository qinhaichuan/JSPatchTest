...
//    [JSPatch startWithAppKey:@"269013972e4345b4"];
...
//    [JSPatch setupRSAPublicKey:@""];
    ...
    // 测试使用, 默认在本地bundle中查找main.js文件, 不能与startWithAppKey同时使用
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "QHC.JSPatch" in the application's documents directory.
